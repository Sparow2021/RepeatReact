...
52:14 --- ref ссылка (суть в том что напрямую к элементам DOM дерева в реакте стучаться нежелательно, но бывают моменты когда это необходисо)!
Неуправляемый, Неконтрлируемый компонент через REF